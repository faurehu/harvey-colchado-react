  ...
  return (
    <div className="conocimiento-page">
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            <h3>1. Ley 31990 - Debilitamiento de la Colaboración Eficaz</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-azul">
        <div className="container">
          <div className="blog-post-content">
            <h3>2. Ley 32108 - Blindaje a Organizaciones Criminales y Partidos Políticos</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            <h3>3. Ley 32138 - Más Obstáculos contra el Crimen Organizado</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-azul">
        <div className="container">
          <div className="blog-post-content">
            <h3>4. Ley 32130 - Traslado del Poder de Investigación a la Policía</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            <h3>5. Ley 32326 - Blindaje de Activos Ilícitos</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-azul">
        <div className="container">
          <div className="blog-post-content">
            <h3>6. Ley 31989 - Protección a la Minería Ilegal</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            <h3>7. Ley 32054 - Inmunidad para Partidos Políticos Criminales</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-azul">
        <div className="container">
          <div className="blog-post-content">
            <h3>8. Ley 31751 - "Ley Soto": Prescripción Express para Corruptos</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            <h3>9. Ley 32104 - Obligación de Aplicar la "Ley Soto"</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-azul">
        <div className="container">
          <div className="blog-post-content">
            <h3>10. Ley 31973 - Deforestación Legalizada</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            <h3>11. Ley 32107 - Prescripción de Crímenes de Lesa Humanidad</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-azul">
        <div className="container">
          <div className="blog-post-content">
            <h3>12. Ley 32419 - Amnistía "Humanitaria" para Violadores de Derechos Humanos</h3>
            <p>
      ...
      <section className="apoyo-section apoyo-amarillo">
        <div className="container">
          <div className="blog-post-content">
            ...
            <p>
              Haz clic en cualquier matriz para verla en detalle y navegar entre los diferentes partidos.
            </p>
          </div>

          <div className="voting-matrices-grid">
            {votingMatrices.map((matrix, index) => (
              <div key={index} className="matrix-card" onClick={() => setSelectedMatrix(index)}>
                <img src={matrix.image} alt={`Matriz de votación ${matrix.name}`} />
                <p className="matrix-name">{matrix.name}</p>
              </div>
            ))}
          </div>
        </div>
