      ...
      <section className="transparencia-content">
        <div className="container">
          <div className="transparencia-text">
            ...
            <p>En esta sección presentaremos próximamente de manera detallada el balance económico de la campaña, reafirmando que creemos en una democracia que se fortalece cuando la ciudadanía puede vigilar, preguntar y exigir.</p>
          </div>
        </div>
      </section>
    </>
