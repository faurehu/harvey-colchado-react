  ...
  return (
    <>
      ...
      <section className="mitos-hero">
        <img className="hero-image" src="/images/verdadomito/portada-mitos.png" alt="Tumbando Mitos" />
        ...
        <div className="container">
          ...
          <div className="mito-content">
            ...
            <div className="mito-images">
              <img src="/images/verdadomito/mito1.png" alt="Mito 1 - Harvey Colchado" className="mito-image" />
            </div>
          </div>
        </div>
      </section>
